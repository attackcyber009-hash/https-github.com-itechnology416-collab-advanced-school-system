...
export default function QuickActionRibbon({
  ...
  const parentActions = [
    ...
    {
      id: 'parent-quick-payment',
      label: 'Fee Payment Gateway',
      icon: CreditCard,
      bg: 'bg-[#20c997] hover:bg-[#1ba87e]',
      action: () => onSelectTab('digital_payment_gateway'),
    },
    {
      id: 'parent-quick-calc',
      label: 'Family Fee Calculator',
      icon: DollarSign,
      bg: 'bg-[#fd7e14] hover:bg-[#e06b0b]',
      action: () => onSelectTab('family_fee_calculator'),
    },
    {
